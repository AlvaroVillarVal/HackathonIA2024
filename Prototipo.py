...
X1 = data_normalized1.drop(["Ratio de aparición de los objetos","Distancia al jugador de los objetos.","Ratio de recompensa de los objetos.","Tamaño de los objetos."], axis=1)  # Use all columns except targets as features
...
for i in range(0,100):
    ...
    lista_tasa_aciertos.append(tasa_aciertos) 
# Assuming 'lista_tasa_aciertos' is your list
plt.plot(lista_tasa_aciertos)
